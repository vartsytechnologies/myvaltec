    ...
    return(<>
        <Container className="defPt defPb">
            <Row className="mt-4 flex-column">
                        <Col><h1 className='defheadFont text-danger' data-aos="fade-up">About Us</h1></Col>
                        <Col>
                            <Row className="justify-content-between align-items-start" >
                                <Col className='ps-0 defbodyFont' data-aos="fade-up" data-aos-delay="300">Valtec Limited, established in August 2015, is a Ghanaian
                                        ...
                                        in West Africa.
                                <p className="mt-4" data-aos="fade-up" data-aos-delay="400"><DefaultButton name ="Read More" variant = "danger" /></p>
                                </Col>
                                <Col xs={12} lg={6} className='zoom-out-container' data-aos="fade-up" data-aos-delay="500">
