        ...
        <Row>
          <Col md={7} className="ps-0">
            <p data-aos="fade-left">
              ...
              in Africa with specialized precision, real-time speed,
              reliability, and sustainable solutions. Delivering value through
              technology solutions is the core principle that drives our
              innovation and commitments to our clients.
            </p>
          </Col>
          <Col md={5}>
            <img
