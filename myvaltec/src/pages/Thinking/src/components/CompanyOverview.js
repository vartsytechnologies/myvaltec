  ...
  return (
    <Container className="my-5">
      ...
      <Row>
        ...
        <Col md={5}>
          <img src={companyOverview} alt="Company" className="img-fluid" data-aos="fade-right"/>
        </Col>
      </Row>
    </Container>
  );
