    ...
    <div className="container my-4">
      <div className="row">
        {images.map((src, index) => (
          <div key={index} className="col-md-3 col-sm-4 mb-4"> 
            <div className="image-wrapper border rounded shadow-sm"> {/* Bootstrap border and shadow */}
              <img src={src} alt={`Gallery ${index + 1}`} className="img-fluid rounded" />
            </div>
          </div>
        ))}
      </div>
