...
const partners = [
  [kin_r, "https://www.generalkinematics.com"],
  [agamine_r, "https://www.agaminesolar.com"],
  [fulltrades_r, "https://www.fulltrades.com"],
  [kimray_r, "https://www.kimray.com"],
  [micin_r, "https://www.microtransindia.com"],
  [pana_r, "https://www.bakerhughes.com/panametrics"],
  [russ_r, "https://www.rmeglobal.com"],
  [druck_r, "https://www.bakerhughes.com/druck"],
        ...
        <Row className="align-items-around justify-content-center mt-0 pt-0 pb-5 mb-5">
          {partners.map((partner, index) => (
            <Col
              ...
              sm={4}
              md={3}
              className="align-self-center justify-content-center my-0 py-0"
            >
